...
#define	  COM15_R01FE	  0x80	  //            01 to FE
#define   COM15_R00FF	  0xc0	  //            00 to FF
#define   COM15_RGB   	  0x00	  // RGB565 output
#define   COM15_RGB565	  0x10	  // RGB565 output
#define   COM15_RGB555	  0x30	  // RGB555 output
#define REG_COM11	0x3b	// Control 11
#define   COM11_NIGHT	  0x80	  // NIght mode enable
...
#define REG_DBLV            0x6b  //  PLL control & internal regulator ( reg =  on )
...
#define REG_SCALING_XSC     0x70   // Bit[6:0]: Horizontal scale factor, def 3A
#define REG_SCALING_YSC     0x71   // Bit[6:0]: Vertical scale factor, def 35
...
#define REG_SCALING_PCLK_DELAY 0xA2  // Bit[6:0]: Scaling output delay, def 0x02
...
//    	{REG_COM8, COM8_FASTAEC|COM8_AECSTEP|COM8_AGC|COM8_AEC|COM8_AWB },
      ...
      {REG_CLKRC, 0x80},
      {REG_COM11, 0x0A},
//      {REG_COM7, 0x00}, // output format: yuv
// colorbar       
{REG_COM7, 0x02}, // output format: yuv, color bar
...
const struct regval_list qvga_yuv_ov7670[] PROGMEM = {
...
const struct regval_list vga_yuv_ov7670[] PROGMEM = {
...
const struct regval_list ov7670_qqvga_ORG[] PROGMEM = {
		{REG_HSTART,0x16},
		{REG_HSTOP,	0x04},
		{REG_HREF, 0x24},
		{REG_VSTART, 0x02},
...
const struct regval_list ov7670_qvga_ORG[] PROGMEM = {
		{REG_HSTART,0x16},
		{REG_HSTOP,	0x04},
		{REG_HREF, 0x24},
		{REG_VSTART, 0x02},
		...
		// scaling
    {REG_COM3, COM3_QVGA},
    {REG_COM14, COM14_QVGA},
    {REG_SCALING_XSC, SCALING_XSC_QVGA},
    {REG_SCALING_YSC, SCALING_YSC_QVGA},
    {REG_SCALING_DCWCTR, SCALING_DCWCTR_QVGA},
    {REG_SCALING_PCLK_DIV, SCALING_PCLK_DIV_QVGA},
    {REG_SCALING_PCLK_DELAY, SCALING_PCLK_DELAY_QVGA},
...
const struct regval_list ov7670_fmt_yuv422_ORG[] PROGMEM =
{
		{ REG_RGB444, 0 },
...
const struct regval_list ov7670_ORG[] PROGMEM =
{
    //--------------------------------------------------------------------------
    // Gamma curve values
    //--------------------------------------------------------------------------
